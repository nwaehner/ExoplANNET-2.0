.. pygpr documentation master file, created by
...
Installation
------------
``pygpr`` is available in the PyPI_. You can therefore install it using the ``pip`` command::
...
--------------------
The package implements the GaussianProcess :ref:py:class:pygpr: GaussianProcess class and the 
